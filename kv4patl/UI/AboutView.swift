...
struct AboutView: View {
    ...
    private let citations = [
        ...
        "Apple Inc. \"vDSP.\" Accelerate Documentation, 2026, https://developer.apple.com/documentation/accelerate/vdsp.",
        "Apple Inc. \"Fast Fourier Transforms.\" Accelerate Documentation, 2026, https://developer.apple.com/documentation/accelerate/fast-fourier-transforms.",
        "Apple Inc. \"Signal Extraction from Noise.\" Accelerate Documentation, 2026, https://developer.apple.com/documentation/Accelerate/signal-extraction-from-noise.",
        ...
        "Boll, Steven F. \"Suppression of Acoustic Noise in Speech Using Spectral Subtraction.\" IEEE Transactions on Acoustics, Speech, and Signal Processing, vol. 27, no. 2, 1979, pp. 113-120.",
