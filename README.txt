...
- Current source-build status: iPhone device-SDK build passed, native macOS build and APRS map/composer UI QA passed, shared macOS protocol tests passed 31/31, and the BLE firmware/flasher package was regenerated for shared version 0.3.4. The self-contained web flasher embeds firmware manifest version `0.3.4-fw17-ble`.
