...
- Version 0.2.6 improves radio-side APRS receive sensitivity by matching the AFSK demodulator to the actual ADC sample rate and feeding it a normalized pre-speaker-gain audio tap.
...
- Current source-build status: simulator build/test passed, BLE firmware esp32dev-release build passed, and the physical KV4P HT was flashed/verified on 2026-06-15 for shared version 0.2.3. The 0.2.6 source change rebuilds the BLE firmware image and self-contained browser flasher with APRS RX demodulator conditioning.
